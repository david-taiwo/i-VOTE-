  ...
  return (
    <div>
      ...
      {/* <div className="absolute inset-0 bg-gradient-to-br from-indigo-50 via-white to-blue-50 -z-10" /> */}
        ...
        <div className="w-full max-w-7xl mx-auto px-6 md:px-8 lg:px-12 text-[#28257a]">
          <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-10 lg:gap-0">
            ...
            <div className="lg:col-span-7 order-2 lg:order-1 relative z-10 space-y-6 text-center lg:text-left">
              <h1 className="max-w-full text-[#0d0a4f] tracking-tight leading-tight flex justify-center lg:justify-start items-center flex-wrap gap-2">
              ...
              <div className="pt-2">
                <button className="px-6 py-3 rounded-full bg-[linear-gradient(90deg,#141157,#1209b0)] text-white font-semibold shadow-md hover:shadow-lg transition">
                  Register as a Voter
                </button>
              </div>
            </div>
      ...
      <section className='flex flex-col items-center justify-center text-[#28257a]'>
        <div aria-label="Three step process" className="w-full flex ">
          <div className="w-full">
            <div 
              className="relative bg-[linear-gradient(90deg,#141157,#1209b0)] h-auto md:h-[27vh] py-8 md:py-0 shadow-[inset_0_2px_0_rgba(0,0,0,0.06)]"
            >
                ...
                >
                  <div className=" rounded-2xl md:rounded-t-xl p-5 sm:p-6 md:p-3.5 md:pt-13 md:px-6 text-center md:text-left">
                    ...
                    <div className="mt-3 sm:mt-2 text-center">
                      <Link
                        href="#"
                        className="inline-block text-[.7rem] font-semibold px-4 py-1 rounded-full bg-white border border-slate-800 text- shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#1209b0] focus:ring-offset-2"
      ...
      {/* Features Section */}
      <section className='relative md:max-h-[70vh] bg-white flex overflow-hidden text-[#28257a]'>
