      ...
      <div className="w-full max-w-7xl mx-auto px-6 md:px-8 lg:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-10 lg:gap-0">
          ...
          <div className="lg:col-span-7 order-2 lg:order-1 relative z-10 space-y-6 text-center lg:text-left">
            <h1 className="tracking-tight leading-tight flex justify-center lg:justify-start items-center flex-wrap gap-2">
              ...
              <span className="inline-block align-middle">
                <Image
                  ...
                  width={200}
                  height={700}
                  className="h-[40px] md:h-[48px] lg:h-[52px] w-auto object-contain"
                />
              </span>
            ...
            <p className="max-w-xl text-[15px] md:text-base leading-relaxed text-slate-600">
              Let’s make voting and elections easy and secure for you.{' '}
