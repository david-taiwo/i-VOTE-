...
export default function SignUpPage() {
  ...
  return (
    <>
      <h1 className="text-2xl font-extrabold text-slate-900 md:text-3xl">Welcome!</h1>
      <p className="mt-1 text-slate-600">
        Welcome to iVOTE’s Online Voting System, please register as a voter to vote in your preferred candidate.
      </p>
      ...
      <div className="mt-6 space-y-4">
        ...
        <div>
          ...
          <p className="mt-1 text-xs text-slate-500">Use letters, numbers and symbols (min 8 chars).</p>
        </div>
        ...
        <div>
          <div className="relative">
            <input
              ...
              className="w-full rounded-full border border-slate-300 px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
        </div>
        ...
        <p className="text-center text-sm text-slate-600">
          ...
          <a href="/(onboarding)/signIn" className="font-semibold text-indigo-600">
            Sign in
          </a>
        </p>
      </div>
